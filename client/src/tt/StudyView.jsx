...
export default function StudyView({ tasks }) {
  ...
  useEffect(() => { api('/study-sessions').then(rows => setSession(rows.find(x => x.status === 'running') || null)).catch(() => {}); }, []);
