...
const P = {
  ...
  settings: <><circle cx="12" cy="12" r="3.2" /><path d="M12 2.6v2.6M12 18.8v2.6M21.4 12h-2.6M5.2 12H2.6M18.6 5.4l-1.9 1.9M7.3 16.7l-1.9 1.9M18.6 18.6l-1.9-1.9M7.3 7.3L5.4 5.4" /></>,
...
export const PALETTE = [
  ...
  // 日系傳統色（NIPPON COLORS 精選：太相近的已剔除、優先保留知名色，依色系分類、由淺到深）
  { name: '日系・粉紅', colors: [['#FEDFE1', '桜'], ['#F596AA', '桃'], ['#B19693', '桜鼠'], ['#F17C67', '珊瑚朱'], ['#E16B8C', '紅梅']] },
  { name: '日系・赤紅', colors: [['#B9887D', '水がき'], ['#F75C2F', '紅緋'], ['#D05A6E', '今様'], ['#E03C8A', '躑躅'], ['#CC543A', '緋'], ['#E83015', '猩猩緋'], ['#954A45', '小豆'], ['#CB1B45', '紅'], ['#64363C', '桑染']] },
  { name: '日系・橙', colors: [['#FAD689', '浅黄'], ['#DAC9A6', '鳥の子'], ['#F6C555', '梔子'], ['#DCB879', '白橡'], ['#FFB11B', '山吹'], ['#FB966E', '洗朱'], ['#E2943B', '朽葉'], ['#B68E55', '黄土'], ['#F05E1C', '黄丹'], ['#C1693C', '樺']] },
  { name: '日系・黃', colors: [['#FBE251', '黄蘗'], ['#D9CD90', '蒸栗'], ['#EFBB24', '鬱金'], ['#CAAD5F', '芥子'], ['#ADA142', '青朽葉']] },
  { name: '日系・茶褐', colors: [['#D7C4BB', '灰桜'], ['#B4A582', '利休白茶'], ['#947A6D', '胡桃'], ['#838A2D', '苔'], ['#96632E', '丁子茶'], ['#6C6024', '鶯茶'], ['#52433D', '紅消鼠']] },
  { name: '日系・綠', colors: [['#A8D8B9', '白緑'], ['#91B493', '薄青'], ['#86C166', '苗'], ['#5DAC81', '若竹'], ['#7BA23F', '萌黄'], ['#89916B', '梅幸茶'], ['#4F726C', '沈香茶'], ['#227D51', '緑'], ['#00896C', '青竹'], ['#42602D', '松葉'], ['#26453D', '鉄']] },
  { name: '日系・藍', colors: [['#A5DEE4', '瓶覗'], ['#81C7D4', '水'], ['#58B2DC', '空'], ['#69B0AC', '青磁'], ['#8B81C3', '藤'], ['#2EA9DF', '露草'], ['#3A8FB7', '千草'], ['#6E75A4', '藤鼠'], ['#268785', '青碧'], ['#566C73', '藍鼠'], ['#0089A7', '新橋'], ['#4E4F97', '紅掛花'], ['#005CAF', '瑠璃'], ['#0D5661', '藍'], ['#113285', '紺青'], ['#211E55', '紺桔梗'], ['#08192D', '褐']] },
  { name: '日系・紫', colors: [['#B481BB', '紅藤'], ['#8A6BBE', '藤紫'], ['#C1328E', '牡丹'], ['#6A4C9C', '桔梗'], ['#592C63', '紫'], ['#3C2F41', '紫紺']] },
  { name: '日系・黑白灰', colors: [['#FFFFFB', '胡粉'], ['#BDC0BA', '白鼠'], ['#91989F', '銀鼠'], ['#707C74', '利休鼠'], ['#434343', '消炭'], ['#1C1C1C', '墨']] },
